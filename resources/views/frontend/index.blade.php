  ...
  <div class="container">
    <div class="row">
                      ...
                      <div class="row product-micro-row">
                        ...
                        <div class="col col-xs-7">
                          <div class="product-info">
                            <h3 class="name"><a href="{{url('product/details/'.$product->id.'/'.$product->product_slug_en)}}"> @if (session()->get('language') == 'Kiswahili'){{ $product->product_name_swa}} @else {{ $product->product_name_en }} @endif</a></h3>
                            <div class="rating rateit-small"></div>

                            @if ($product->discount_price == NULL)
                            <div class="product-price"> <span class="price"> Ksh {{$product->selling_price}} </span> </div>
                            @else
                            <div class="product-price"> <span class="price"> Ksh {{$product->discount_price}} </span> </div>
                            @endif
                            <!-- /.product-price -->
      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  ...
                  <h6 class="text">Extra Ksh 5 off on all items </h6>
                </div>
              </div>
              <!-- .col -->
            </div>
        ...
        <div>
            ...
            @else
            <div class="tag hot"><span>-{{ round($discount) }}%<br></span></div>
    ...
    <div class="product-info text-left">
        <h3 class="name"><a href="{{url('product/details/'.$product->id.'/'.$product->product_slug_en)}}">
            @if (session()->get('language') == 'Kiswahili'){{ $product->product_name_swa}} @else {{ $product->product_name_en }} @endif
              </a></h3>
        <div class="rating rateit-small"></div>
        ...
        <div class="product-price"> <span class="price"> Ksh {{$product->selling_price}} </span> </div>
            ...
            @else
            <div class="product-price"> <span class="price">  Ksh {{$product->discount_price}} </span> <span class="price-before-discount"> Ksh {{$product->selling_price}}</span> </div>
...
@foreach ($categories as $category)
 ...
 <!-- ======================= SKIP PRODUCTS 0 ======================= -->
 <section class="section featured-product wow fadeInUp">
    <h3 class="section-title"> @if (session()->get('language') == 'Kiswahili'){{$skip_category_0->category_name_swa}} @else {{$skip_category_0->category_name_en}} @endif</h3>
    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
  ...
  <!-- ======================= SKIP PRODUCTS 1 ==================== -->
 <section class="section featured-product wow fadeInUp">
    <h3 class="section-title"> @if (session()->get('language') == 'Kiswahili'){{$skip_category_1->category_name_swa}} @else {{$skip_category_1->category_name_en}} @endif</h3>
    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
              ...
              <div class="cart clearfix animate-effect">
                  ...
                  <ul class="list-unstyled">
                      <li class="add-cart-button btn-group">
                            ...
                            <li class="lnk wishlist"> <a data-toggle="tooltip" class="add-to-cart"  title="Add to Wishlist" id="{{$product->id}}" onclick="addToWishList(this.id)"> <i class="icon fa fa-heart"></i> </a>
                            </li>
                            <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart" href="detail.html" title="Compare"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
                  </ul>
                  </div>
 ...
 <section class="section featured-product wow fadeInUp">
    <h3 class="section-title"> @if (session()->get('language') == 'Kiswahili'){{$skip_brand_1->brand_name_swa}} @else {{$skip_brand_1->brand_name_en}} @endif</h3>
    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
  ...
  <!-- ============================ BRAND PRODUCT : END ========================================= -->
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        ...
                        <div class="col2 col-xs-7">
                          <div class="product-info">
                            <h3 class="name"><a href="#">Floral Print Buttone</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> $450.99 </span> </div>
                            <!-- /.product-price -->
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        ...
                        <div class="col2 col-xs-7">
                          <div class="product-info">
                            <h3 class="name"><a href="#">Floral Print Button</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> $450.99 </span> </div>
                            <!-- /.product-price -->
        ...
        <section class="section wow fadeInUp new-arriavls">
            ...
            <div>
                ...
                @else
                <div class="tag hot"><span>{{ round($discount) }}%OFF</span></div>
                ...
                @endif
                    ...
                    <div class="product-info text-left">
                      <h3 class="name"><a href="{{url('product/details/'.$item->id.'/'.$item->product_slug_en)}}">@if (session()->get('language') == 'Kiswahili'){{ $item->product_name_swa}} @else {{ $item->product_name_en }} @endif</a></h3>
                      <div class="rating rateit-small"></div>
                      <div class="description"></div>

                      @if ($item->discount_price == NULL)

          <div class="product-price"> <span class="price"> Ksh {{$item->selling_price}} </span> </div>

              @else
              <div class="product-price"> <span class="price">  Ksh {{$item->discount_price}} </span> <span class="price-before-discount"> Ksh {{$item->selling_price}}</span> </div>
              ...
              @endif
                    ...
                    <div class="cart clearfix animate-effect">
                      <div class="action">
                        <ul class="list-unstyled">
                          <li class="add-cart-button btn-group">
                            <button class="btn btn-primary icon" title="Add to Cart" data-toggle="modal" data-target="#exampleModal" id="{{$item->id}}" onclick="productView(this.id)" type="button"> <i class="fa fa-shopping-cart"></i> </button>
                            <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
                          </li>
                          <li class="lnk wishlist"> <a class="add-to-cart" title="Add to Wishlist" id="{{$item->id}}" onclick="addToWishList(this.id)" title="Add to Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
