                ...
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							...
							<div class="description-container m-t-20">
								@if (session()->get('language') == 'Kiswahili'){!!$product->short_description_swa!!} @else {!!$product->short_description_en!!} @endif
                    ...
                    <div class="col-sm-6">
                        <div class="price-box">
                            ...
                            @else
                            <span class="price">Ksh {{$product->discount_price}}</span>
                            <span class="price-strike">Ksh {{$product->selling_price}}</span>
                            @endif
                        ...
                        <div class="col-sm-6">
                            ...
                            {{-- add produt color and size START --}}
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if (session()->get('language') == 'Kiswahili'){!!$product->long_description_swa!!} @else {!!$product->long_description_en!!} @endif</p>
									</div>
								</div><!-- /.tab-pane -->
	...
	<div class="product">
		...
		<div class="product-info text-left">
			...
			<div class="product-price">
                ...
                @else
                <span class="price">Ksh {{$product->discount_price}}	</span>
			     <span class="price-before-discount">Ksh {{$product->selling_price}}</span>
                @endif
