...
<div class="body-content">
    ...
    <h1>@if (session()->get('language') == 'Kiswahili'){{$blogPost->post_title_swa}} @else {{$blogPost->post_title_en}} @endif</h1>
    ...
    <p>@if (session()->get('language') == 'Kiswahili'){!!$blogPost->post_details_swa!!} @else {!!$blogPost->post_details_en!!} @endif</p>
