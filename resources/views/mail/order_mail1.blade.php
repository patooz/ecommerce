                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding-bottom: 10px;">
                                            <a href="http://127.0.0.1:8000"><img src="{{asset('frontend/assets/images/logo.png')}}" class="logo" alt="logo" /></a>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                            Phone: 310-807-6672 | Email: info@ndonyoshop.co.ke
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 14px; line-height: 18px; color: #666666; padding-bottom: 25px;">
                                            <strong>Order Number:</strong> {{$order['invoce_no']}} | <strong>Order Date:</strong> {{$order['order_date']}}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="4" style="padding-right: 10px; padding-bottom: 10px;">
                                            <img style="height: 80px;" src="{{asset ($item->options->image)}}" alt="Product Image" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 14px; line-height: 18px; color: #757575; text-align: right; padding-bottom: 10px;">
                                            <b style="color: #666666;">Ksh {{$order['amount']}}</b> Total
                                        </td>
                                    </tr>
